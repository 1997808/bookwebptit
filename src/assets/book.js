export const bookData = [
  ...
  {
    id: "175808907369962",
    image: "/assets/bookImage/vangbong.jpg",
...

  {
    ...
    price: "96.000 VNĐ",
    sale: "false",
    description: "Nathan Fawles là một nhà văn nổi tiếng, đã tuyên bố ngừng viết và đến ẩn mình trên đảo Beaumont nơi người dân sống tách biệt với phần còn lại của thế giới. Khát khao gặp gỡ thần tượng đời mình, Raphaël, một nhà văn tập sự, đã một ngày kia cập bến đảo, cùng thời điểm với Mathilde, một nữ phóng viên trẻ tuổi có phần bí ẩn. Giữa ba con người tưởng chừng xa lạ ấy liệu có tồn tại mối dây liên kết nào? Cái xác người phụ nữ bị tra tấn dã man và gắn trên cây cổ thụ của đảo thuộc về ai. Thông điệp từ Cuộc sống bí ẩn của các nhà văn chắc chắn là lời tỏ tình tuyệt đẹp mà Musso dành cho việc đọc, và cả việc viết."
  },

  {
    id: "195808907369962",
    image: "/assets/bookImage/chienluoc.jpg",
    name: "Quản lý chiến lược",
    author: "Koji Mitani",
    translator: "Mai Phương",
    ...
    price: "120.000 VNĐ",
    sale: "false",
    description: "“Quản lý chiến lược” sẽ giúp bạn xem xét tình huống của chính công ty mình một cách nghiêm túc và xem xét loại “chiến lược” và “cách xây dựng” từ bây giờ. Nhưng với tình hình hiện tại, không có nhiều thời gian để suy nghĩ cẩn thận. Thời đại ngày nay yêu cầu không phải là thực hiện thử nghiệm, mà là thử và sai với tốc độ cao. Hãy chọn một lý thuyết chiến lược phù hợp với tình hình và khả năng của bạn, cải thiện nó và sử dụng như một kỹ năng cần thiết của công ty bạn."
  },

  {
    id: "205808907369962",
    image: "/assets/bookImage/suluoc.jpg",
    ...
    price: "100.000 VNĐ",
    sale: "false",
    description: "Với Việt Nam sử lược, sử học Việt Nam lần đầu tiên có một công trình thoát ly được khỏi lối chép sử biên niên truyền thống của Trung Quốc vốn chỉ nêu lên từng sự kiện riêng lẻ, rời rạc. Việt Nam sử lược trình bày các diễn biến lịch sử thành một câu chuyện liên tục và hấp dẫn, cho người đọc thấy được mối liên lạc nhân quả, biện chứng giữa các sự kiện xảy ra theo dòng thời gian. Ngoài ra, khác với lối chép sử của các sử thần thời phong kiến thường chỉ chú ý ghi chép hành vi, hoạt động của vua chúa quan lại, những cuộc tranh bá đồ vương, Việt Nam sử lược trái lại đã bắt đầu chú ý nhiều đến những sự kiện liên quan đời sống thực tế của dân chúng, sinh hoạt của xã hội, phong tục, tín ngưỡng, v.v... Tất cả đều được thể hiện với một thái độ điềm tĩnh, khách quan, và công bằng đúng như một sử gia cần có."
  },
  {
    id: "215808907369962",
    image: "/assets/bookImage/thegioi.jpg",
    name: "Các Thế Giới Song Song",
    author: "Michio Kaku",
    translator: " Vương Ngân Hà ",
    publisher: "Nhã Nam",
    category: "Sách Khoa học – Kỹ thuật",
    cat: "edu",
    pages: 483,
    size: "15 x 24",
    price: "85.000 VNĐ",
    sale: "false",
    description: "Một chuyến du hành đầy trí tuệ qua các vũ trụ, được dẫn dắt tài tình bởi 'thuyền trưởng' Michio Kaku và độc giả có dịp chiêm ngưỡng vẻ đẹp kì vĩ của vũ trụ kể từ vụ nổ lớn, vượt qua những hố đen, lỗ sâu, bước vào các thế giới lượng tử muôn màu kì lạ nằm ngay trước mũi chúng ta, vốn dĩ tồn tại song song trên một màng bên ngoài không - thời gian bốn chiều, ngắm nhìn thực tại vật chất quen thuộc hòa quyện với thế giới của những điều diệu kỳ như năng lượng và vật chất tối, sự này chồi của các vũ trụ, những chiều không gian bí ẩn và sự biến ảo của các dây rung siêu nhỏ..."
  },
  {
    id: "225808907369962",
    image: "/assets/bookImage/conlua.jpg",
    name: "Lên đường với Trái tim trần trụi - Tôi là một con lừa",
  ...
  },
  {
    ...
    price: "54.500 VNĐ",
    sale: "false",
    description: "Thắc mắc nhỏ, ngỏ cùng em là bộ sách đến từ nước Pháp, dành cho trẻ từ 6 tuổi trở lên. Sách giải đáp cho những câu hỏi vừa ngây thơ, vừa hóc búa của các em theo cách cơ bản, dễ hiểu cùng minh họa sinh động.Bộ sách giúp các bé bước đầu khám phá những điều thú vị về cuộc sống, từ các khái niệm như Tốt và xầu; Chiến tranh và hòa bình; Giàu và nghèo cho tới các chủ đề gần gũi hơn như các cung bậc cảm xúc, tình cảm, tìm hiểu về giới tính và hệ bài tiết trong cơ thể."
  },
  {
    id: "245808907369962",
    image: "/assets/bookImage/chuyendoi.jpg",
    name: "Một chuyện đời",
    author: "Shogo Sato",
    translator: "Phong Thu",
    publisher: "Nhã Nam",
    category: "Sách Trinh thám",
    cat: "other",
    pages: 448,
    size: "14 x 20.5",
    price: "54.500 VNĐ",
    sale: "false",
    description: "Trong phút bốc đồng, cô nhân viên hiệu sách Michiru bỏ lại công việc, bạn trai và gia đình, rời khỏi miền quê ven biển bình lặng để chạy theo một người đàn ông có vợ lên Tokyo. Nhưng Tokyo hóa ra không phải vùng đất hứa như cô tưởng tượng. Thất nghiệp, túng tiền, tình yêu dần phai nhạt, cuộc sống mới của Michiru rơi vào bế tắc và tuyệt vọng, cho đến khi cô phát hiện tờ vé số mà người đồng nghiệp ở quê nhờ mua hộ trúng giải độc đắc hai trăm triệu yên.Hai trăm triệu yên! Một số tiền có thể giúp Michiru sống sung túc tại Tokyo đến cuối đời. Nhưng Michiru không thể ngờ, tờ vé số cô những tưởng là thứ cứu rỗi cuộc đời mình đó lại trở thành tấm vé tiễn cô vào một hành trình đầy âm mưu, dối lừa và tội ác."
  },
  {
    id: "255808907369962",
    image: "/assets/bookImage/giongto.jpg",
    name: "Giông Tố",
